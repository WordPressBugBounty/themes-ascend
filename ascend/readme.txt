...
Ascend Theme through the Patchstack
Vulnerability Disclosure Program https://patchstack.com/database/vdp/ascend. The
...
Ascend theme's source code through the
Patchstack Vulnerability Disclosure
Program https://patchstack.com/database/vdp/ascend. The Patchstack team will
...
= Version 1.4.14 | 23rd May 2024 =
* Update: WC template notice.
* Update: X formerly twitter icon.
* Fix: PHP 8.2 notices.

= Version 1.4.13 | 26th September 2023 =
* Update: WC template notice.
* Fix: Issue with button sizes not rendering correctly.

= Version 1.4.12 | 15th June 2023 =
* Update: WC template notice.
